...
type
  _TClientID = packed record
    UniqueProcess:cardinal;
    UniqueThread:cardinal;
  end;
  TClientID = _TClientID;
  PClientID = ^TClientID;

  _TUnicodeString = packed record
    Length: Word;
    MaximumLength: Word;
    Buffer: PWideChar;
  end;
  TUnicodeString = _TUnicodeString;
 ...
 {                                 //    Value   Query   Set
  ...
  _SYSTEM_LOAD_IMAGE = packed record
  ...
  _FILE_FULL_EA_INFORMATION = packed record
...
type
  ...
  _SYSTEM_MODULE_INFORMATION_EX = packed record
    ModulesCount: dword;
    Modules: array[0..0] of SYSTEM_MODULE_INFORMATION;
  end;
  SYSTEM_MODULE_INFORMATION_EX  = _SYSTEM_MODULE_INFORMATION_EX;
...
begin
  Result := nil;
  mSize := $4000; //ia¡Àaeuiue ©£acia©£ aoooa©£a
